...
6. Review icons at all system/App Store sizes, native layouts, accessibility, runtime behavior and the remaining test limitations in the report. Revalidate native status typography, complete readings and one/three/seven-stat startup after restoring Text presentation. Historical bitmap-label measurements do not establish the restored label's behavior; crowded/notched display testing remains in the release matrix.
